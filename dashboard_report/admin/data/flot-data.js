...
$(function() {
    ...
    var data =[{
                ...
                data: numOrderConfirmationPending
            },{
                label: "Order Confirmed",
                data: numOrderConfirmed 
            }, {
                label: "Order sent for processing",
                data: numOrderSentForProcessing 
            }, {
                label: "Liquid mould Sent ",
                data: numLiquidMouldSent 
            },{
                label: "Liquid mould received ",
                data: numLiquidMouldReceived 
            },{
                label: "Mould Ready",
                data: numMouldReady 
            },{
                label: "RPT / wax pc received",
                data: numRptWaxPcReceived 
            },{
                label: "RPT / wax pc Sent",
                data: numnumRPTWaxPcSent 
            },{
                label: "Sent for manufacturing",
                data: numSentFormanufacturing 
            },{
                label: "Casting sent",
                data: numCastingsent 
            },{
                label: "Casting received",
                data: numCastingReceived 
            },{
                label: "Diamond  / gemstone request sent",
                data: numDiamondGemstoneRequestSent  
            },{
                label: "Diamond / Gemstone received",
                data: numDiamondGemstoneReceived 
            },{
                label: "Product request sent",
                data: numProductRequestSent 
            },{
                label: "Setting",
                data: numSetting 
            },{
                ...
                label: "Quality check",
                data: numQualityCheck 
            },{
                label: "Final Product Received",
                data: numFinalProductReceived 
            },{
                label: "Certification",
                data: numCertification 
            },{
                label: "Invoicing",
                data: numInvoicing 
            },{
                ...
                data: numProductShipped 
            },{
                label: "Product Delivered",
                data: numProductDelivered 
            },{
                label: "Cancelled",
                data: numCancelled 
            },{
