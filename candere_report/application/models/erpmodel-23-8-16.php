...
class ERPModel extends CI_Model 
{
 ...
 WHERE $status_in $where $search order by $sort $dir ";
...
// echo '</pre>' ;
    ...
    { 
		...
		erp_order_details.diamond_1_stones, erp_order_details.diamond_2_stones,	erp_order_details.diamond_3_stones,	erp_order_details.diamond_4_stones,	erp_order_details.diamond_5_stones,	erp_order_details.diamond_6_stones,	erp_order_details.diamond_7_stones,	erp_order_details.diamond_1_weight,	erp_order_details.diamond_2_weight,	erp_order_details.diamond_3_weight,	erp_order_details.diamond_4_weight,	erp_order_details.diamond_5_weight,	erp_order_details.diamond_6_weight,	erp_order_details.diamond_7_weight,	erp_order_details.diamond_1_clarity,	erp_order_details.diamond_2_clarity,	erp_order_details.diamond_3_clarity,	erp_order_details.diamond_4_clarity,	erp_order_details.diamond_5_clarity,	erp_order_details.diamond_6_clarity,	erp_order_details.diamond_7_clarity,	erp_order_details.diamond_1_shape,	erp_order_details.diamond_2_shape,	erp_order_details.diamond_3_shape,	erp_order_details.diamond_4_shape,	erp_order_details.diamond_5_shape,	erp_order_details.diamond_6_shape,	erp_order_details.diamond_7_shape,	erp_order_details.diamond_1_color,	erp_order_details.diamond_2_color,	erp_order_details.diamond_3_color,	erp_order_details.diamond_4_color,	erp_order_details.diamond_5_color,	erp_order_details.diamond_6_color,	erp_order_details.diamond_7_color,	
		erp_order_details.diamond_1_setting_type,	erp_order_details.diamond_2_setting_type,	erp_order_details.diamond_3_setting_type,	erp_order_details.diamond_4_setting_type,	erp_order_details.diamond_5_setting_type,	erp_order_details.diamond_6_setting_type,	erp_order_details.diamond_7_setting_type,erp_order_details.diamond_1_size,	erp_order_details.diamond_2_size,	erp_order_details.diamond_3_size,	erp_order_details.diamond_4_size,	erp_order_details.diamond_5_size,	erp_order_details.diamond_6_size,	erp_order_details.diamond_7_size,
		
		
		erp_order_details.gem_1_status, erp_order_details.gem_2_status, erp_order_details.gem_3_status, erp_order_details.gem_4_status, erp_order_details.gem_5_status, 
		erp_order_details.gemstone_1_stone,	erp_order_details.gemstone_2_stone,	erp_order_details.gemstone_3_stone,	erp_order_details.gemstone_4_stone,	erp_order_details.gemstone_5_stone,	erp_order_details.gemstone_1_type,	erp_order_details.gemstone_2_type,	erp_order_details.gemstone_3_type,	erp_order_details.gemstone_4_type,	erp_order_details.gemstone_5_type,	erp_order_details.gemstone_1_color,	erp_order_details.gemstone_2_color,	erp_order_details.gemstone_3_color,	erp_order_details.gemstone_4_color,	erp_order_details.gemstone_5_color,	erp_order_details.gemstone_1_shape,	erp_order_details.gemstone_2_shape,	erp_order_details.gemstone_3_shape,	erp_order_details.gemstone_4_shape,	erp_order_details.gemstone_5_shape,	erp_order_details.gemstone_1_setting_type,	erp_order_details.gemstone_2_setting_type,	erp_order_details.gemstone_3_setting_type,	erp_order_details.gemstone_4_setting_type,	erp_order_details.gemstone_5_setting_type,	erp_order_details.gemstone_1_weight,	erp_order_details.gemstone_2_weight,	erp_order_details.gemstone_3_weight,	erp_order_details.gemstone_4_weight,	erp_order_details.gemstone_5_weight")
              ->from('erp_order')
	...
	{
		echo $query = $this->db->query("SELECT c.id,  c.order_id,  c.sku,  c.quantity,   c.unit_price,   ed.product_image,   c.product_name,  c.quantity, ed.erp_order_id, cd.order_status_id,  mststatus.status_name
		FROM    (   (   (   (SELECT MAX(id) AS max_id,
                              trnorderprocessing.order_product_id
                         FROM trnorderprocessing trnorderprocessing
                       GROUP BY trnorderprocessing.order_product_id) c_max
