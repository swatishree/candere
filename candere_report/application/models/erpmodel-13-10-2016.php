...
class ERPModel extends CI_Model 
{
	...
	public function email_activities($search_order_id, $limit, $start)
	{
		...
		if($param == 'inbox')
		{
			$query 		= $this->db->query("select e.*, u.username from email_activities e left join user_signup u on e.email_from=u.user_id where e.email_to='".$_user_id."' limit $start, $limit");
		}
		else if($param == 'outbox')
		{
			$query 		= $this->db->query("select e.*, u.username from email_activities e left join user_signup u on e.email_to=u.user_id where e.email_from='".$_user_id."' limit $start, $limit");
		}
		else if($param == 'sent_mail')
		{
			...
			$query 		= $this->db->query("select e.*, u.username from email_activities e left join user_signup u on e.email_to=u.user_id limit $start, $limit");
		}
