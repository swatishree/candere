...
class ERPModel extends CI_Model 
{
 ...
 WHERE $status_in $where $search order by $sort $dir limit $start, $limit";
 ...
 //WHERE 1
    ...
    {
        $query = $this->db->query('SELECT status_id, status_name FROM mststatus order by sequence ASC');
        return $query->result();
    }
