...
class Candere_Products extends CI_Controller  {
	...
	{ 
        ...
        $this->load->view("candere/index",$message_arr);
	...
	{ 	
		...
		if($sql){
			...
			foreach($sql as $value){
				...
				$top_thickness			= $value['top_thickness'];
				$bottom_thickness		= $value['bottom_thickness'];
	...
	public function myqueryfunction($label){	
       ...
       pricing_table_metal_options.purity AS purity_id,
       catalog_product_entity_varchar_9.value AS top_thickness,
       catalog_product_entity_varchar_10.value AS bottom_thickness
  FROM    (   (   (   (   (   (   (   (   (   (   (   (   (   (   (   (   (   (   (   (   metal_options_enabled metal_options_enabled
               ...
               ON (catalog_product_entity_int.value =
                      eav_attribute_option_value_2.option_id))
           INNER JOIN
              catalog_product_entity_varchar catalog_product_entity_varchar_9
           ON (metal_options_enabled.product_id =
                  catalog_product_entity_varchar_9.entity_id))
       INNER JOIN
          catalog_product_entity_varchar catalog_product_entity_varchar_10
       ON (metal_options_enabled.product_id =
              catalog_product_entity_varchar_10.entity_id)
 WHERE     (catalog_product_entity_varchar_9.attribute_id = 278)
       AND (catalog_product_entity_varchar_10.attribute_id = 280)
       AND (    (    eav_attribute_option_value_2.value = '$label'
            ...
            AND (    catalog_product_entity_varchar_8.attribute_id = 135
                 AND (    catalog_product_entity_varchar_7.attribute_id = 282
                      AND (    (    (    (    catalog_product_entity_int_1.attribute_id =
                                                 96
                                          AND catalog_product_entity_int_1.value =
                                                 1)
...
ORDER BY metal_options_enabled.product_id DESC";
	...
	public function export_all_product_images() {
		...
		$sql = "SELECT pricing_table_metal_options.sku,
		 ...
		 WHERE (    (    metal_options_enabled.status = 1
					 AND pricing_table_metal_options.status = 1)
				AND catalog_product_entity_int.attribute_id = 96 AND catalog_product_entity_int.value = 1)
		ORDER BY pricing_table_metal_options.sku ASC, purity_id ASC";
		...
		foreach($result as $row) {
			...
			$results_imgs 	= $results_images->result_array() ;
				...
				$img_1 = isset($img_array['img_1']) ? $img_array['img_1'] : '';
				$img_2 = isset($img_array['img_2']) ? $img_array['img_2'] : '';
				$img_3 = isset($img_array['img_3']) ? $img_array['img_3'] : '';
				$img_4 = isset($img_array['img_4']) ? $img_array['img_4'] : '';
				$img_5 = isset($img_array['img_5']) ? $img_array['img_5'] : '';
				$img_6 = isset($img_array['img_6']) ? $img_array['img_6'] : '';
				
				$array[] = array('sku'=>$sku, 'metal'=>$metal, 'purity'=>$purity, 'img_1' => $img_1, 'img_2' => $img_2, 'img_3' => $img_3,'img_4' => $img_4,'img_5' => $img_5,'img_6' => $img_6);
		...
		array_to_csv($array,'candere_product_images_'.date('d-M-y').'.csv');
