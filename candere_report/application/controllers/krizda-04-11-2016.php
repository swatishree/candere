...
class Krizda extends CI_Controller  {
	...
	{ 	echo "exportDefaultProductsOnly"; exit;
		$this->db->cache_delete_all();
	...
	public function exportdefaultfunction($label){	
	 	echo "exportdefaultfunction"; exit;
		$this->db->cache_delete_all();
...
ORDER BY metal_options_enabled.product_id ASC"; 
	...
	public function myqueryfunction(){	echo "myqueryfunction"; exit;
	$this->db->cache_delete_all();
		//$this->db->insert('pricingupdate', $pricingupdate);	
		$sql =	"SELECT DISTINCT
       pricing_table_metal_options.product_id,
...
ORDER BY metal_options_enabled.product_id ASC"; 
	...
	public function myqueryfunctionimages(){ echo "myqueryfunctionimages"; exit;
		$this->db->cache_delete_all();
		$result_array = array();
 ...
 WHERE     (pricing_table_metal_options.status = 1)
	...
	{  echo "exportproductscategory"; exit;
		$this->db->cache_delete_all();
		$message_arr = array('');
		//$this->load->library('export'); 
		$this->load->helper('csv');
	...
	public function myqueryfunctioncategory(){	   echo "myqueryfunctioncategory"; exit;
		$this->db->cache_delete_all();
		//$this->db->insert('pricingupdate', $pricingupdate);	
		$sql =	"SELECT  pricing_table_metal_options.sku
 , catalog_product_entity_varchar.value as name
