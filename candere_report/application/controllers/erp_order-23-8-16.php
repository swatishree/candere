...
class Erp_Order extends Auth_Controller  {
	...
	{
		$array_complete 	= array('complete','shipped');
		$allow_status 		= $this->session->userdata('order_status');
	...
	public function product_updates()
	{
		...
		$data['prod_updates'] 	= $this->erpmodel->getNonFinishedProducts($search, $limit, $start);
	...
	public function set_next_state()
	{
		...
		$update_status = $this->input->post('order_status_id') + 1;
	...
	public function saveproductdetails()
	{
		...
		$row_data['diamond_1_stones'] 		= $this->input->post('diamond_1_count');
		...
		$row_data['diamond_2_stones'] 		= $this->input->post('diamond_2_count');
		...
		$row_data['diamond_3_stones'] 		= $this->input->post('diamond_3_count');
		...
		$row_data['diamond_4_stones'] 		= $this->input->post('diamond_4_count');
		...
		$row_data['diamond_5_stones'] 		= $this->input->post('diamond_5_count');
		...
		$row_data['diamond_6_stones'] 		= $this->input->post('diamond_6_count');
		...
		$row_data['diamond_7_stones'] 		= $this->input->post('diamond_7_count');
		...
		$row_data['diamond_8_stones'] 		= $this->input->post('diamond_8_count');
		...
		$row_data['diamond_9_stones'] 		= $this->input->post('diamond_9_count');
		...
		$row_data['diamond_10_stones'] 		= $this->input->post('diamond_10_count');
		...
		$row_data['gemstone_1_type'] 		= $this->input->post('gemstone_1_name');
		...
		$row_data['gemstone_2_type'] 		= $this->input->post('gemstone_2_name');
		...
		$row_data['gemstone_3_type'] 		= $this->input->post('gemstone_3_name');
		...
		$row_data['gemstone_4_type'] 		= $this->input->post('gemstone_4_name');
		...
		$row_data['gemstone_5_type'] 		= $this->input->post('gemstone_5_name');
		...
		$row_data['gemstone_6_type'] 		= $this->input->post('gemstone_6_name');
		$row_data['gemstone_6_count'] 		= $this->input->post('gemstone_6_count');
		...
		$row_data['gemstone_7_type'] 		= $this->input->post('gemstone_7_name');
		$row_data['gemstone_7_count'] 		= $this->input->post('gemstone_7_count');
		...
		$row_data['gemstone_8_type'] 		= $this->input->post('gemstone_8_name');
		$row_data['gemstone_8_count'] 		= $this->input->post('gemstone_8_count');
		...
		$row_data['gemstone_9_type'] 		= $this->input->post('gemstone_9_name');
		$row_data['gemstone_9_count'] 		= $this->input->post('gemstone_9_count');
