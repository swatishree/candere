...
class Erp_Order extends Auth_Controller  {
	...
	public function processing_orders()
	{
		...
		$data['processdata'] 	= $this->erpmodel->order_details($array_processing, $proc_status, $search, $sort, $dir, $limit, $start);
	...
	public function create_marketplace_order()
	{
		...
		$this->form_validation->set_rules('metal_weight_approx', 'metal_weight_approx', 'trim|xss_clean|required');
		$this->form_validation->set_rules('total_weight_approx', 'total_weight_approx', 'trim|xss_clean|required');
