...
class Krizda extends CI_Controller  {
	...
	{ 
		...
		if($sql){
			...
			$array[0]['gemstone_1_setting_type'] = 'gemstone_1_setting_type';
			...
			$array[0]['gemstone_2_setting_type'] = 'gemstone_2_setting_type';
			...
			$array[0]['gemstone_3_setting_type'] = 'gemstone_3_setting_type';
			...
			$array[0]['gemstone_4_setting_type'] = 'gemstone_4_setting_type';
			...
			$array[0]['gemstone_5_setting_type'] = 'gemstone_5_setting_type';
			...
			foreach($sql as $value){
				...
				*/
				...
				FROM
				 ...
				 ON (catalog_category_entity_varchar.entity_id = catalog_category_entity_int.entity_id)
				WHERE (catalog_category_entity_int.attribute_id = 42)
				 AND (catalog_category_entity_int.value = 1) AND (catalog_category_entity_varchar.attribute_id  = 41 AND (((((pricing_table_metal_options.status  = 1 AND metal_options_enabled.isdefault  = 1) AND metal_options_enabled.status  = 1) AND metal_options_enabled.product_id  = $product_id) AND pricing_table_metal_options.isdefault  = 1) AND catalog_product_entity_varchar.attribute_id  = 71))
				...
				if($result){
					...
					foreach($result as $value){ 
						...
						if($diamond_1 == 1){ 
							...
							$array[$counter]['diamond_1_weight'] = $diamond_1_weight ;
							$array[$counter]['diamond_1_no_of_diamonds'] = $diamond_1_no_of_diamonds ;
						...
						if($result){
							...
							foreach($result as $value){ 
								...
								//$sql = "select gemstone_1 as shape_1 ,gemstone_2 as shape_2 ,gemstone_3  as shape_3 ,gemstone_4 as shape_4 ,gemstone_5 as shape_5  from gemstone_attributes where attribute_id = 218 and product_id = $product_id"; 294
								
								/****************************************************************************/
								$sql_setting_type = "SELECT gemstone_attributes.product_id, eav_attribute_option_value.value AS setting_type_1,
										   eav_attribute_option_value_1.value AS setting_type_2,
										   eav_attribute_option_value_2.value AS setting_type_3,
										   eav_attribute_option_value_3.value AS setting_type_4,
										   eav_attribute_option_value_4.value AS setting_type_5
									  FROM    (   (   (   (   gemstone_attributes gemstone_attributes
										   ...
										   ON (gemstone_attributes.gemstone_5 =
												  eav_attribute_option_value_4.option_id)
									 WHERE     (gemstone_attributes.attribute_id = 294)
										   AND (gemstone_attributes.product_id = $product_id)";  

								$results_setting_type = $this->db->query($sql_setting_type);
								$result_setting_type = $results_setting_type->row_array();
								
								/*echo "<pre>";
								print_r($result_setting_type);
								echo "</pre>"; exit;*/
								
								if($result_setting_type){   
									$gemstone_1_setting_type	= $result_setting_type['setting_type_1'];
									$gemstone_2_setting_type	= $result_setting_type['setting_type_2'];
									$gemstone_3_setting_type	= $result_setting_type['setting_type_3'];
									$gemstone_4_setting_type	= $result_setting_type['setting_type_4'];
									$gemstone_5_setting_type	= $result_setting_type['setting_type_5'];
								}
								/****************************************************************************/
								...
								if($gemstone_1 == 1){ 
									...
									$array[$counter]['gemstone_1_setting_type'] = $gemstone_1_setting_type ; 
								}else{
									...
									$array[$counter]['gemstone_1_setting_type'] = ''; 
								}
								...
								if($gemstone_2 == 1){ 
									...
									$array[$counter]['gemstone_2_setting_type'] = $gemstone_2_setting_type ;
								}else{
									...
									$array[$counter]['gemstone_2_setting_type'] = '';									
								}
								...
								if($gemstone_3 == 1){ 
									...
									$array[$counter]['gemstone_3_setting_type'] = $gemstone_3_setting_type ;
								}else{
									...
									$array[$counter]['gemstone_3_setting_type'] = '';
								}
								...
								if($gemstone_4 == 1){ 
									...
									$array[$counter]['gemstone_4_setting_type'] = $gemstone_4_setting_type ;									
								}else{
									...
									$array[$counter]['gemstone_4_setting_type'] = '';
								}
								...
								if($gemstone_5 == 1){ 
									...
									$array[$counter]['gemstone_5_setting_type'] = $gemstone_5_setting_type ;
								}else{
									...
									$array[$counter]['gemstone_5_setting_type'] = '';
								}
							}
						}
					} 
	...
	public function exportDefaultProductsOnly()
	{
		$this->db->cache_delete_all();
		...
		//$this->load->library('export'); 
		$this->load->helper('csv');
		$sql = $this->exportdefaultfunction($type);
		$this->load->dbutil();
		$array = array();
		if($sql){
			$counter = 1 ; 
	...
	public function exportdefaultfunction($label){
		$this->db->cache_delete_all();
       ...
       IF(catalog_product_entity_int_1.value = 1, 'Enabled', 'Disabled')
          AS product_status,
       metal_options_enabled.isdefault
 ...
 WHERE (    (    (     
       catalog_product_entity_int.value  = $label
        ...
        AND (    catalog_product_entity_int_3.attribute_id = 163
             AND (    catalog_product_entity_varchar_8.attribute_id = 135
                  AND (    catalog_product_entity_varchar_7.attribute_id =
                              282
