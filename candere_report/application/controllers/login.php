...
class Login extends CI_Controller{
	...
	private function _login_success()
	{
		 ...
		 $logged_in_session = $this->session->userdata('logged_in');
		//echo $this->session->userdata('_username') ;
 ...
 if( $this->session->userdata('_username')=='cad' || $this->session->userdata('_username')=='manufacturing')
   {
        redirect(base_url('index.php').'/erp_order/to_do');	 
   }
