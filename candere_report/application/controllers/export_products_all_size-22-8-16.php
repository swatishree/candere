...
class Export_products_all_size extends CI_Controller  {
	...
	public function export_products()
	{
		...
		if($category == 'Rings' || $category == 'Bands')
			$market_place_table = 'product_price_rings_bands';
		else
			$market_place_table = 'product_price_market_place';
		
		if($type == 'diamond')
			$sel_products = "select * from $market_place_table where product_type= '".$category."' and purity='".$purity."' and diamond_flag =1 ";
		else if($type == 'gold')
			$sel_products = "select * from $market_place_table where product_type= '".$category."' and purity='".$purity."' and gold_flag =1 ";
		else if($type == 'gemstone')
			$sel_products = "select * from $market_place_table where product_type= '".$category."' and purity='".$purity."' and diamond_flag =0 and gemstone_flag=1 ";
		else
			$sel_products = "select * from $market_place_table where product_type= '".$category."' and purity='".$purity."'";
	...
	public function export_products_backup()
	{
		$category 		= $_REQUEST['category'];
