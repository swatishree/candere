...
class Customer_orders_count extends CI_Controller  {
	...
	{   
		...
		$sql = "select 
			...
			( select sum(sfo.base_grand_total) from sales_flat_order sfo where sfo.customer_id = sales_flat_order.customer_id and sfo.created_at  between '$from_date 00:00:00' and '$to_date 23:59:59' and sfo.state in ('$implode_state')) as grand_total,  
