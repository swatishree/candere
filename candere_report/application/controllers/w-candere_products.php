...
class Candere_Products extends CI_Controller  {
	...
	{ 	
		...
		if($sql){
			...
			$array[0]['product_id'] 			= 'product_id';
			$array[0]['sku'] 					= 'sku';
			$array[0]['metal_id'] 				= 'metal_id';
			$array[0]['purity_id'] 				= 'purity_id';
			$array[0]['name'] 					= 'name';
			$array[0]['metal'] 					= 'metal';
			...
			$array[0]['default_metal_weight'] 	= 'metal_weight';
			$array[0]['default_total_weight'] 	= 'total_weight';
			...
			$array[0]['price'] 					= 'price';
			$array[0]['price_after_discount'] 	= 'price_after_discount';		
	...
	public function myqueryfunction($label){	
       ...
       ON (catalog_product_entity_int.value =
              eav_attribute_option_value_2.option_id)
 WHERE (    (     (    eav_attribute_option_value_2.value = '$label'
