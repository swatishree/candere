...
class Exportorders extends CI_Controller  {
	...
	{  
		...
		$this->load->helper('csv');
		$sql = $this->fn_customer_address_with_order_export_query_1();
  ...
  FROM    (   sales_flat_order sales_flat_order
	...
	public function fn_customer_address_with_order_export_query_1(){	
		 $this->db->cache_delete_all();
       ...
       sales_flat_order_item.sku AS name, 
       sales_order_status.label AS order_status,
...
$results = $this->db->query($sql);
 ...
 WHERE     (sales_flat_quote.abandoned_mail_sent = 1)
	...
	public function export_order_details_with_customer_shipping_address() {
