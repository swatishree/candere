...
<li style="clear:both;">
	...
	<label style="float: left;margin-left: 3%;width:120px;">Receipt Date</label>
    <input type="text" name="receipt_date" id="datepicker" class="field-style field-split align-right"  value="" />
</li>


<li style="clear:both;">
	<label style="float: left;margin-left: 2%;width:125px;">Metal</label>
    <?php echo $metal_dropdown; ?>
	...
	<label style="float: left;margin-left:3%;width:120px;">Total Diamond Count</label>
    <input type="text" name="total_diamond_count" id="total_diamond_count" class="field-style field-split align-right"  value="" />
	
	<?php } ?>
</li>

<li style="clear:both;">
	<label style="float: left;margin-left: 2%;width:125px;">Metal Purity</label>
    <?php echo $purity_dropdown ?>
	...
	<label style="float: left;margin-left:3%;width:120px;">Total Gemstone Count</label>
    <input type="text" name="total_gemstone_count" id="total_gemstone_count" class="field-style field-split align-right"  value="" />
	<?php } ?>
</li>


<li style="clear:both;">
	<label style="float: left;margin-left: 2%;width:125px;">Metal Weight</label>
    <input type="text" name="metal_weight" id="metal_weight" class="field-style field-split align-left"  value="<?php echo $metal_weight ?>" />
	<label style="float: left;margin-left:3%;width:120px;">Total Weight</label>
    <input type="text" name="total_weight" id="total_weight" class="field-style field-split align-right"  value="<?php echo $total_weight ?>" />
</li>
...
<li style="clear:both;">
   ...
   <input type="text" name="diamond_1_count" id="diamond_1_count" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_1_count ?>" />
   <?php } ?>
	
	<?php if($selectdata->diamond_2_status == 1){ ?>
	<input type="text" name="diamond_2_count" id="diamond_2_count" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_2_count ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_3_status == 1){ ?>
	<input type="text" name="diamond_3_count" id="diamond_3_count" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_3_count ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_4_status == 1){ ?>
	<input type="text" name="diamond_4_count" id="diamond_4_count" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_4_count ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_5_status == 1){ ?>
	<input type="text" name="diamond_5_count" id="diamond_5_count" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_5_count ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_6_status == 1){ ?>
	<input type="text" name="diamond_6_count" id="diamond_6_count" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_6_count ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_7_status == 1){ ?>
	<input type="text" name="diamond_7_count" id="diamond_7_count" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_7_count ?>" />
	<?php } ?>
</li>
...
<li style="clear:both;">
	...
	<?php if($selectdata->diamond_1_status == 1){ ?>
    <input type="text" name="diamond_1_weight" id="diamond_1_weight" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_1_weight ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_2_status == 1){ ?>
	<input type="text" name="diamond_2_weight" id="diamond_2_weight" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_2_weight ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_3_status == 1){ ?>
	<input type="text" name="diamond_3_weight" id="diamond_3_weight" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_3_weight ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_4_status == 1){ ?>
	<input type="text" name="diamond_4_weight" id="diamond_4_weight" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_4_weight ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_5_status == 1){ ?>
	<input type="text" name="diamond_5_weight" id="diamond_5_weight" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_5_weight ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_6_status == 1){ ?>
	<input type="text" name="diamond_6_weight" id="diamond_6_weight" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_6_weight ?>" />
	<?php } ?>
	
	<?php if($selectdata->diamond_7_status == 1){ ?>
	<input type="text" name="diamond_7_weight" id="diamond_7_weight" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_7_weight ?>" />
	<?php } ?>
</li>

<li style="clear:both;">
	<label style="float: left;margin-left: 2%;width:197px;">Diamond Clarity</label>
	
	<?php if($selectdata->diamond_1_status == 1){ echo $clarity_1_dropdown; } ?>
	
	<?php if($selectdata->diamond_2_status == 1){ echo $clarity_2_dropdown; } ?>
	
	<?php if($selectdata->diamond_3_status == 1){ echo $clarity_3_dropdown; } ?>
	
	<?php if($selectdata->diamond_4_status == 1){ echo $clarity_4_dropdown; } ?>
	
	<?php if($selectdata->diamond_5_status == 1){ echo $clarity_5_dropdown; } ?>
	
	<?php if($selectdata->diamond_6_status == 1){ echo $clarity_6_dropdown; } ?>
	
	<?php if($selectdata->diamond_7_status == 1){ echo $clarity_7_dropdown; } ?>
</li>

<li style="clear:both;">
	<label style="float: left;margin-left: 2%;width:197px;">Diamond Color</label>
	
	<?php if($selectdata->diamond_1_status == 1){ echo $color_1_dropdown; } ?>
	
	<?php if($selectdata->diamond_2_status == 1){ echo $color_2_dropdown; } ?>
	
	<?php if($selectdata->diamond_3_status == 1){ echo $color_3_dropdown; } ?>
	
	<?php if($selectdata->diamond_4_status == 1){ echo $color_4_dropdown; } ?>
	
	<?php if($selectdata->diamond_5_status == 1){ echo $color_5_dropdown; } ?>
	
	<?php if($selectdata->diamond_6_status == 1){ echo $color_6_dropdown; } ?>
	
	<?php if($selectdata->diamond_7_status == 1){ echo $color_7_dropdown;} ?>
</li>
