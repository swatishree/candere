...
<li style="clear:both;">
  ...
  <br/> diamond_1_count&nbsp;&nbsp;<input type="text" name="diamond_1_stones" id="diamond_1_stones" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_1_stones ?>" />  <br/>
	...
	diamond_10_count&nbsp;&nbsp;<input type="text" name="diamond_10_stones" id="diamond_10_stones" class="field-style field-split" style="width:130px;"  value="<?php echo $diamond_10_stones ?>" /> 
</li>
...
<li style="clear:both;">
   ...
   <br/> gemstone_1_name <input type="text" name="gemstone_1_type" id="gemstone_1_type" class="field-style field-split" style="width:130px;"  value="<?php echo $gemstone_1_type ?>" /><br/>
...
<li style="clear:both;">
    ...
    <br/> gemstone_1_count <input type="text" name="gemstone_1_stone" id="gemstone_1_stone" class="field-style field-split" style="width:130px;"  value="<?php echo $gemstone_1_stone ?>" /><br/>
...
<li style="clear:both;">
  ...
  <br/> gemstone_1_weight <input type="text" name="gemstone_1_weight" id="gemstone_1_weight" class="field-style field-split" style="width:130px;"  value="<?php echo $gemstone_1_weight ?>" /><br/>
...
<li style="clear:both;">
  ...
  <br/> gemstone_1_shape <input type="text" name="gemstone_1_shape" id="gemstone_1_shape" class="field-style field-split" style="width:130px;"  value="<?php echo $gemstone_1_shape ?>" /><br/>
...
<li style="clear:both;">
  ...
  <br/> gemstone_1_color <input type="text" name="gemstone_1_color" id="gemstone_1_color" class="field-style field-split" style="width:130px;"  value="<?php echo $gemstone_1_color ?>" /><br/>
...
<li style="clear:both;">
  ...
  <br/> gemstone_1_setting_type <input type="text" name="gemstone_1_setting_type" id="gemstone_1_setting_type" class="field-style field-split" style="width:130px;"  value="<?php echo $gemstone_1_setting_type ?>" /><br/>
