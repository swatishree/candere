...
<ul id="buttons">
   ...
   { ?>
	    <li class="active"><a href="<?php echo base_url('index.php/erp_order/to_do')?>"><b>To Do List</b></a></li>  
   <?php } ?>
	 <?php
...
<form action="<?php echo base_url('index.php/erp_order/to_do_list'); ?>" enctype="multipart/form-data" method="post">
	<br /> 
	<input type = "submit" value = "Export Data" name="sbmt_to_do_list" id="sbmt_to_do_list" class="styled-button-1" style="width:150px;" />
</form>
</div>
						...
						<tr>
							...
							<tbody>
								...
								if($row->engrave_message!='') {
									$order_table .= '<td style="color:red"><b>Engrave Message : </b>'.htmlspecialchars($row->engrave_message).'</td>';
								}
								$order_table .='</tr>';
								...
								if($row->engrave_font!='') {
									$order_table .= '<td style="color:red"><b>Engrave Font : </b>'.$row->engrave_font.'</td>';
								}
								$order_table .='</tr>';
								...
								if($row->chain_length) {	
									$order_table .='<td width="150" class="nowrap"><b>Chain Length:</b>'.$row->chain_length.' (in)</td>';
								}
								$order_table .= '</tr>';
								...
								$order_table .= '<tr>';
								if($row->description!='') {	
									$order_table .='<td width="140" style="color:red ;"><b>special comments: : </b>'.$row->description.'</td>';
								}
								$order_table .= '</tr>';
