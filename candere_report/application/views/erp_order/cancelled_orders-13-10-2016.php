...
<ul id="buttons">
   ...
   <?php } ?>   
	 <?php
   if( $this->session->userdata('_username')=='cad' || $this->session->userdata('_username')=='manufacturing' || $this->session->userdata('_username')=='procurement' || $this->session->userdata('_username')=='Rupesh Jain' || $this->session->userdata('_username')=='cad')
   { ?>
   ...
   { ?>
	...
	<li class="active"><a href="<?php echo base_url('index.php/erp_order/cancelled_orders')?>"><b>Cancelled Orders</b></a></li>
...
echo '<form method="POST" name="sts_form" action="'.base_url('index.php/erp_order/cancelled_orders').'">';
      $options = array(
 				  'Magento'  =>       'Magento',
				  'flipkart'  =>       'flipkart',
				  'Amazon.in'  =>		'Amazon.in',
...
<input type="hidden" name="viewtype" value="cancelled">
...
echo '</form>'; ?>
<form action="<?php echo base_url('index.php/erp_order/cancelled_orders'); ?>" enctype="multipart/form-data" method="post">
	<br /> 
	<input type = "submit" value = "Export Data" name="sbmt_cancelled_order" id="sbmt_cancelled_order" class="styled-button-1" style="width:150px;" />
</form>
</div>
<script>
$(document).ready(function() {
...
<?php 
	...
	$complete_table = '<table width="100%" cellspacing=0 cellpadding=0 class="complete_table" name="complete_table" id="complete_table" style="padding:0 10px 20px 10px;">
		<tr height="40" style="padding-bottom:100px;">
			...
			<th align="left" class="th_color">Marketplace</th>
