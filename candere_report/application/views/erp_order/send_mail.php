...
$form_action 	= base_url('index.php/erp_order/saveemaildetails');

  ?>

<div style="padding-top:60px;">

<h1 style="float:left; width:200px; color: #305A72;  margin-left:6%; font-size:13px; clear:both; ">Compose Mail</h1>
...
<li style="clear:both;">
	<label style="float: left;margin-left: 2%;width:125px;">Product Name</label>
...
<li style="clear:both;">
  <label style="float: left;margin-left: 2%;width:229px;"> Compose Mail </label>
  <?php
		...
		$user_email = array_combine($user_implode, $email_implode);							
		 ...
		 ?>
		<select name="user_email[]" id="user_email" style="padding: 9 10 64 22"	multiple class="field-style field-split align-left" >
...
<li style="clear:both;">
 ...
 <label style="float: left;margin-left: 2%;width:229px;"> Priority</label>
		<select name="priority" id="priority" class="field-style field-split align-left" >
...
<li style="clear:both;">
 ...
 <label style="float: left;margin-left: 2%;width:125px;"> Subject</label><input type="text" name="subject" id="subject" class="field-style field-split align-left"  value="<?php echo $subject; ?>"  /><br/>	
 </li>

<li style="clear:both;">
<label style="float: left;margin-left: 2%;width:125px;">  Content</label><input type="text" name="content" id="content" class="field-style field-split align-left"  value="<?php echo $content; ?>"  /><br/>
</li>
