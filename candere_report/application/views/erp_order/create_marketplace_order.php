...
$(function() {
	...
	$( "#order_placed_date,#dispatch_date" ).datepicker();
});
...
<div style="clear:both;">
	<span class="err_left"><b>MarketPlace</b></span>
</div>
...
<div style="clear:both;">
	<span class="err_left"><b>Order ID</b></span>
	<span class="err_right"><b>Order Product Id</b></span>
</div>
<li style="clear:both;">
...
<div style="clear:both;">
	<span class="err_left"><b>SKU</b></span>
	<span class="err_right"><b>Product name</b></span>
</div>
<li style="clear:both;">
...
<div style="clear:both;">
	<span class="err_left"><b>Metal</b></span>
	<span class="err_right"><b>Purity</b></span>
</div>
<li style="clear:both;">
...
<?php $purity_options = array(
				  ''  		=> 'Select Purity',
				  '22K'  	=> '22K',
				  '18K'  	=> '18K',
				  '14K'  	=> '14K',
				);
echo form_dropdown('purity', $purity_options, set_value('purity'), 'id="purity" class="field-style field-split align-right" style="float:right; margin-right:6%;" '); ?>
</li>
<div style="clear:both;">
	<span class="err_left"><?php echo form_error('metal'); ?></span>
	<span class="err_right"><?php echo form_error('purity'); ?></span>
</div>

<div style="clear:both;">
	<span class="err_left"><b>Size in mm</b></span>
	<span class="err_right"><b>Quantity</b></span>
</div>
<li style="clear:both;">
	<input type="text" name="size" class="field-style field-split align-left" placeholder="Size in mm" value="<?php echo set_value('size'); ?>" />
	<input type="text" name="quantity" class="field-style field-split align-right" placeholder="Quantity" value="<?php echo set_value('quantity'); ?>" />
</li>
<div style="clear:both;">
	<span class="err_left"><?php echo form_error('size'); ?></span>
	<span class="err_right"><?php echo form_error('quantity'); ?></span>
</div>

<div style="clear:both;">
	<span class="err_left"><b>Metal Weight</b></span>
	<span class="err_right"><b>Total Weight</b></span>
</div>
<li style="clear:both;">
...
<div style="clear:both;">
	<span class="err_left"><b>Price</b></span>
</div>
<li style="clear:both;">
	<input type="text" name="price" class="field-style field-split align-left" placeholder="Price" value="<?php echo set_value('price'); ?>" />
</li>
<div style="clear:both;">
	<span class="err_left"><?php echo form_error('price'); ?></span>
	
</div>

<div style="clear:both;">
	<span class="err_left"><b>Customer Name</b></span>
	<span class="err_right"><b>Contact Number</b></span>
</div>
<li style="clear:both;">
	<input type="text" name="customer_name" id="customer_name" class="field-style field-split align-left" placeholder="Customer Name" value="<?php echo set_value('customer_name'); ?>" />
	<input type="text" name="contact_number" class="field-style field-split align-right" placeholder="Contact Number" value="<?php echo set_value('contact_number'); ?>" />
</li>
<div style="clear:both;">
	<span class="err_left"><?php echo form_error('customer_name'); ?></span>
	<span class="err_right"><?php echo form_error('contact_number'); ?></span>
</div>

<div style="clear:both;">
	<span class="err_left"><b>Buyer's Address</b></span>
	<span class="err_right"><b>Shipping Country</b></span>
</div>
<li style="clear:both;">
	...
	<?php $country_option = array(''=>'Select Shipping Country');
...
<div style="clear:both;">
	<span class="err_left"><b>Order Date</b></span>
	<span class="err_right"><b>Dispatch Date</b></span>
</div>
<li style="clear:both;">
	...
	<input type="text" name="dispatch_date" id="dispatch_date" class="field-style field-split align-right" placeholder="Dispatch Date" value="<?php echo set_value('dispatch_date'); ?>" />
</li>
<div style="clear:both;">
	<span class="err_left"><?php echo form_error('order_placed_date'); ?></span>
	<span class="err_right"><?php echo form_error('dispatch_date'); ?></span>
</div>

<div style="clear:both;">
	<span class="err_left"><b>Marketplace Payment</b></span>
	<span class="err_right"><b>Notes</b></span>
</div>
<li style="clear:both;">
	...
	echo form_dropdown('payment_method', $payment_method_options, set_value('payment_method'), 'id="payment_method" class="field-style field-split align-left" style="margin-left:6%;" '); ?>
	<textarea name="notes" class="field-style field-split align-right" placeholder="Notes" id="notes" style="float:right;margin-right:6%;"></textarea>
</li>
<li style="clear:both;"> 
