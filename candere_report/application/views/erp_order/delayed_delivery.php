...
<ul id="buttons">
   ...
   { ?>
	...
	<li><a href="<?php echo base_url('index.php/erp_order/cancelled_orders')?>"><b>Cancelled Orders</b></a></li>
	 ...
	 <li><a href="<?php echo base_url('index.php/erp_order/delayed')?>" class="active"><b>Delayed Delivery</b></a></li>
</ul>
</div>
...
echo '<form method="POST" name="sts_form" action="'.base_url('index.php/erp_order/delayed').'">';
			...
			<td class="bottom" width="580" valign="top" style="padding-top:10px;">
				<table name="product_data" width="100%">
					<tbody>
						...
						<tr><td><b><a href="'.$product_url.'" style="color:#0066CC;text-decoration:none;" target="_blank">'.$rj->product_name.'</a></b></td>
						</tr>
						<tr>
							<td width="400">
