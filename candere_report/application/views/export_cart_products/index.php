...
<?php 
 ...
 WHERE sales_flat_quote.reserved_order_id IS NULL AND  Date(sales_flat_quote_item.updated_at) between '$date_from' AND '$date_to' AND sales_flat_quote.customer_id != 0 order by sales_flat_quote_item.updated_at DESC";
