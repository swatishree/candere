...
<?php
	...
	$html .= '<tr>
				<th>Service enquiries</th> <th>Cart Abandonded Unique</th> <th>Cart Abandonded All</th> <th>Subscribers</th>  <th>Name of Affiliate</th> <th>Campaign</th><th>Source</th>
			</tr>';
?>			
...
<?php 
	...
	if(isset($_POST) && !empty($_POST)){
		...
		//$unique_arr[] = array('affiliate_id'=>'KM-gods_love_10_sep_2015', 'affiliate_medium'=>'cpv', 'affiliate_source'=>'km');
		//$unique_arr[] = array('affiliate_id'=>'KM-ganesha_10_sep_2015', 'affiliate_medium'=>'cpv', 'affiliate_source'=>'km');
		...
		$unique_arr = msort($unique_arr, array('affiliate_id'));
			...
			foreach(array_filter($unique_arr) as $key=>$value) {
				...
				if($affiliate_id) {
					...
					$html .= "<tr>
						<td>$total_query_count</td> <td>$total_unique_cart_count</td> <td>$total_cart_count</td> <td>$total_sub_count</td>  <td>$affiliate_medium</td> <td>$affiliate_id</td><td>$affiliate_source</td>
					</tr>";
				}
