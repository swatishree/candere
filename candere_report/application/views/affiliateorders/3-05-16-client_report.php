		...
		if (strpos($order_status,'canceled') !== false || strpos($order_status,'closed') !== false ) {
			...
			$sql = "SELECT sales_flat_order.increment_id AS order_id,
				   ...
				   ON (sales_flat_order_address.parent_id = sales_flat_order.entity_id)
					 ...
					 WHERE (sales_flat_order_address.address_type = 'billing' AND sales_flat_order.state IN ('$order_status') And (sales_flat_creditmemo.created_at between '$mysql_date_from' AND '$mysql_date_to')) ORDER BY sales_flat_order.entity_id DESC";
