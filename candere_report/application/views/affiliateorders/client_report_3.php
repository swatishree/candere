...
<?php 
	...
	if($date_from > $date_to){
		...
		$sql = "SELECT sales_flat_order.increment_id AS order_id,
					   ...
					   sales_flat_order.state AS order_status,
				 ...
				 WHERE (sales_flat_order.state IN ('$order_status') And (sales_flat_order.created_at between '$mysql_date_from' AND '$mysql_date_to') $where) ORDER BY sales_flat_order.entity_id DESC";
