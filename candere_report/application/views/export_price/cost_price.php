	...
	<div class="holder">
		...
		<br><br>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="50%" align="center">
				<form name="frm" id="frm" method="post" action="<?php echo $this->config->base_url(); ?>/index.php/export_price/sku" >
					<tr>
						...
						</td><td><input type="submit" name="sbmt_sku" id="sbmt_sku" value="Submit"  class="popSignup" style="width:100px;height:30px;"></td>
					</tr>					
					<tr><td colspan="3">&nbsp;</td></tr>
				</form>
			</table>
			<table cellpadding="0" cellspacing="0" border="0" width="50%" align="right">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="50%" align="center">
				<form name="frm" id="frm" method="post" action="<?php echo $this->config->base_url(); ?>/index.php/export_price/index" >
					<tr>
						<td style="width:200px;padding-left:300px;font-size:16px">Date Range</td>
