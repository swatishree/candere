...
class Zend_Markup_BbcodeAndHtmlTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('<a href="https://framework.zend.com/">https://framework.zend.com/</a>',
            $this->_markup->render('[url]https://framework.zend.com/[/url]'));
        $this->assertEquals('<a href="https://framework.zend.com/">foo</a>',
        ...
        $this->assertEquals('<img src="https://framework.zend.com/images/logo.png" alt="logo" />',
            $this->_markup->render('[img]https://framework.zend.com/images/logo.png[/img]'));
        $this->assertEquals('<img src="https://framework.zend.com/images/logo.png" alt="Zend Framework" />',
    ...
    public function testHtmlAliases()
    {
        ...
        $this->assertEquals($m->render('[img]https://google.com/favicon.ico[/img]'),
...
BBCODE;
    ...
    public function testValidUri()
    {
        ...
        $this->assertTrue(!Zend_Markup_Renderer_Html::isValidUri("https:///test"));
        $this->assertTrue(Zend_Markup_Renderer_Html::isValidUri("https://www.example.com"));
    ...
    {
        $this->assertEquals('<a href="https://google.com/&quot;&lt;script&gt;alert(1)&lt;/script&gt;">...</a>',
            $this->_markup->render('[url=\'https://google.com/"<script>alert(1)</script>\']...[/url]'));
        $this->assertEquals('<img src="https://google.com/&amp;quot;&amp;lt;script&amp;gt;alert(1)&amp;lt;/script&amp;gt;" alt="/script&amp;gt;" />',
    ...
    public function testUrlMatchCorrectly()
    {
        ...
        $this->assertEquals('<a href="https://framework.zend.com/">test</a><a href="https://framework.zend.com/">test</a>',
